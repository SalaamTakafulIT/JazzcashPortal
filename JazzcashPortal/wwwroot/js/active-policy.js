...
function GetActivePolicies() {
    ...
    $.ajax({
        url: "/ActivePolicies/GetActivePolicies",
        type: 'GET',
        dataType: 'json',
...
function LoadActivePolicies(data) {
    if ($.fn.dataTable.isDataTable('#tblActivePolicy')) {
        $('#tblActivePolicy').DataTable().clear().destroy();
    }
